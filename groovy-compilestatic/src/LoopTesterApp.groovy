...
/*
 * Java code ported to Groovy by Oliver Plohmann, www.objectscape.org
 */
...
class LoopTesterApp {
    ...
    public void getMem() {
        ...
        long val = (long) (runtime.totalMemory() / 1024L);
        System.out.println("  Total Memory: " + val + " KB");
    }

    public static void main(String[] args) {
        System.out.println("Welcome to LoopTesterApp, Groovy @CompileStatic edition");
